...
### 一键脚本：
```
bash <(wget -qO- https://raw.githubusercontent.com/yonggekkk/x-ui-yg/beta/install.sh)
```
或
```
bash <(curl -Ls https://raw.githubusercontent.com/yonggekkk/x-ui-yg/beta/install.sh)
```
-----------------------------------------------------
